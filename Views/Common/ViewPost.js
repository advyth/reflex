      ...
      return (
        <View style={styles.commentContainer}>
          ...
          <View style={styles.commentInfoView}>
            ...
            <Text style={styles.commentUpvoteText}>{item.data.score}</Text>
          </View>
        </View>
      );
    } else {
    ...
    return (
      ...
      >
        ...
        <View style={styles.headerBar}>
          <Text style={styles.headerBarTitle}>{this.state.postTitle}</Text>
          ...
          <View style={styles.headerBarInfo}>
            ...
            <Text style={styles.headerUpvoteText}>{this.state.score}</Text>
            {this.state.silverAward != null ? (
              <Text style={styles.silver}>
                Silver x{this.state.silverAward}
              </Text>
            ) : null}
            {this.state.goldAward != null ? (
              <Text style={styles.gold}>Gold x{this.state.goldAward}</Text>
            ) : null}
            {this.state.platinumAward != null ? (
        ...
        {this.state.type == "image" ? (
          <Image width={SCREEN_WIDTH} source={{ uri: this.state.url }} />
        ) : null}
        {this.state.type == "selftext" ? (
          <Text style={styles.selfText}>{this.state.selfText}</Text>
        ) : null}
        <View style={styles.commentHeader}>
          <Text style={{ color: "white", fontFamily: "Quicksand-Bold" }}>
            Comments
          </Text>
        </View>
