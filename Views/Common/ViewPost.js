    ...
    render()
    {
        return(<ScrollView
            refreshControl={
                ...
                <TouchableOpacity onPress={()=>{this.navigateToUrl(this.state.url,this.state.type,this.state.postTitle)}}><Text style={styles.postUrlText}>link : {this.state.url}</Text></TouchableOpacity>
